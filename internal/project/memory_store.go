...
func (s *MemoryStore) Create(
	...
	autonomyPolicy, err := NormalizeAutonomyPolicy(createdProject.AutonomyPolicy)
	if err != nil {
		return err
	}
...
func (s *MemoryStore) UpdateAutonomyPolicy(
	_ context.Context,
	projectID string,
	...
	storedProject.AutonomyPolicy = normalized
