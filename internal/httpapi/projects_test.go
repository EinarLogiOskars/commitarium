...
func TestCreateProject(t *testing.T) {
	...
	New(service, nil, nil, nil, nil).ServeHTTP(recorder, req)
...
func TestCreateProjectRejectsMalformedJSON(t *testing.T) {
	...
	recorder := httptest.NewRecorder()
	New(service, nil, nil, nil, nil).ServeHTTP(recorder, request)
...
func TestGetProjectByID(t *testing.T) {
	...
	recorder := httptest.NewRecorder()
	New(projects, nil, nil, nil, nil).ServeHTTP(recorder, request)
